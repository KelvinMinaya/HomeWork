...
public class ColumbiaUniversity extends MedicalSchool implements VocationalSchool, University {
	...
	/*
	 * The extends keyword is used for inheritance in Regular class. Regular class
	 * can inherit "one" regular or abstract class. Keyword "implement" used to
	 * inherit 1 or more Interface
	 */
